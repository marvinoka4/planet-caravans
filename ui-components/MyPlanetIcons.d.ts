...
export declare type MyPlanetIconsProps = React.PropsWithChildren<Partial<IconProps> & {
...
export default function MyPlanetIcons(props: MyPlanetIconsProps): React.ReactElement;
